window.initError500Animation = () => {
    ...
    if (!stackContainer || !cardNodes.length || !perspecNodes.length || !perspec || !card) {
        console.warn("Error500 animation elements not found. Skipping initialization.");
        return;
    }
